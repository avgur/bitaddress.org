...
define(["EllipticCurve", "SecureRandom", "BigInteger", "BitcoinLib/util"], function (EllipticCurve, SecureRandom, BigInteger, Util) {
	...
	var ECDSA = {
		getBigRandom: function (limit) {
			var bi = new BigInteger(limit.bitLength(), rng)
